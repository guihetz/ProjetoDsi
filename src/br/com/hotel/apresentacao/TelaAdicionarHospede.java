 ...
 * @author daylton
 */
public class TelaAdicionarHospede extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCadastro.setFont(new java.awt.Font("Hotel Oriental", 0, 20)); // NOI18N
        btnCadastro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/hotel/imagem/add.png"))); // NOI18N
        btnCadastro.setText("Adicionar Hospede");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnCadastro, javax.swing.GroupLayout.PREFERRED_SIZE, 428, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        if(!tfEmail.getText().equals("")){
                            if(!ftTelefone.getText().equals("")){
                                if(!dcDataNascimento.getDateFormatString().equals("") && dcDataNascimento.getDate().before(d.getTime())){
                                    ...
                                    h.setEndereco(tfEndereco.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdicionarHospede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
